...
var EditorScene = cc.Scene.extend({
    ...
    onEnter:function () {
        ...
        this.worldLayer.initObjects(TestScenes.static_rotating_collision)
        this.scheduleUpdate();
        window.editor = this
    },
    ...
    update:function(dt){
        ...
        this.worldLayer.removeDeadBodies();
        this.world.ClearForces();
        this.worldLayer.objects.forEach(function(o){
            o.impulseCorrector && o.applyImpulseCorrector();
            o.update(dt)
        })
    },
