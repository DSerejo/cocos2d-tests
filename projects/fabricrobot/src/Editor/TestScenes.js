var TestScenes = {
    'simple_rubber_block':[
        {position:cc.p(200,500),width:50,height:50,type:b2_dynamicBody,angle:30,'class':'box',id:'2','material':Materials.rubber()}
    ],
    ...
    'landing_ship':[
        {position:cc.p(200,100),width:200,height:150,type:b2_dynamicBody,angle:0,'class':'box',id:'1'},
